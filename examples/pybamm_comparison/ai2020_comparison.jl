# # Ai 2020 Parameter Set – BattMo.jl vs PyBaMM Comparison
#
# This example compares discharge curves between BattMo.jl (Chen 2020) and
# PyBaMM (Ai 2020) at multiple C-rates.
#
# The Ai 2020 parameter set is available in PyBaMM's standard library but
...
ax = Axis(fig[1, 1];
	title  = "Ai 2020 (PyBaMM) vs Chen 2020 (BattMo.jl) – CC Discharge",
	xlabel = "Time [s]",
	ylabel = "Voltage [V]",
)
